...
def build_markdown(results: list[dict], now: str, chemdcatap_url: str) -> str:
    ...
    for r in results:
        ...
        rows.append(f"| {ver_label} | {token_cell} | {status_cell} |")
...
def main() -> int:
    ...
    md = build_markdown(results, now, chemdcatap_base)
