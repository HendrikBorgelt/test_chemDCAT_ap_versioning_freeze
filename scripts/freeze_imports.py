...
Usage examples
--------------
Full post-deploy freeze (Phase 2):

    uv run python scripts/freeze_imports.py \\
        --schema-dir src/chem_dcat_ap/schema \\
        --dcatapplus-base https://HendrikBorgelt.github.io/test_dcat_ap_plus_versioning_freeze \\
        --versions-url https://HendrikBorgelt.github.io/test_dcat_ap_plus_versioning_freeze/versions.json \\
        --chemdcatap-base https://HendrikBorgelt.github.io/test_chemDCAT_ap_versioning_freeze/chemistry \\
        --chemdcatap-version v0.5.0 \\
        --convert-bare-imports \\
        --schema-id-old-base https://w3id.org/nfdi-de/dcat-ap-plus \\
        --schema-id-new-base https://HendrikBorgelt.github.io/test_chemDCAT_ap_versioning_freeze
...
def freeze_schema_id(text: str, old_base: str, new_base: str, version: str) -> str:
    ...
    For example, with old_base=https://w3id.org/nfdi-de/dcat-ap-plus,
    new_base=https://HendrikBorgelt.github.io/test_chemDCAT_ap_versioning_freeze,
    version=v0.5.0:

      id: https://w3id.org/nfdi-de/dcat-ap-plus/chemistry/
      -> id: https://HendrikBorgelt.github.io/test_chemDCAT_ap_versioning_freeze/chemistry/v0.5.0/

      id: https://w3id.org/nfdi-de/dcat-ap-plus/chemistry/entity/
      -> id: https://HendrikBorgelt.github.io/test_chemDCAT_ap_versioning_freeze/chemistry/entity/v0.5.0/

    When old_base == new_base (production w3id.org case) the function simply
...
def freeze_own_namespace_prefixes(
    ...
    For example:
      chemical_entities_ap: https://w3id.org/nfdi-de/dcat-ap-plus/chemistry/entity/
      -> chemical_entities_ap: https://HendrikBorgelt.../chemistry/entity/v0.5.0/

      material_entities_ap: https://w3id.org/nfdi-de/dcat-ap-plus/materials/
      -> material_entities_ap: https://HendrikBorgelt.../materials/v0.5.0/
    """
    def _replace(m: re.Match) -> str:
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument(
        ...
        help=(
            ...
            "e.g. https://HendrikBorgelt.github.io/test_chemDCAT_ap_versioning_freeze  "
            "For production use, set this to the same value as --schema-id-old-base "
            "(w3id.org) so only the version is injected."
        ),
    )
    return p
